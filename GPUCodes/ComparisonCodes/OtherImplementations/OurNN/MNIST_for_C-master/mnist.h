...
#define TRAIN_IMAGE "MNIST_for_C-master/data/train-images.idx3-ubyte"
#define TRAIN_LABEL "MNIST_for_C-master/data/train-labels.idx1-ubyte"
#define TEST_IMAGE "MNIST_for_C-master/data/t10k-images.idx3-ubyte"
#define TEST_LABEL "MNIST_for_C-master/data/t10k-labels.idx1-ubyte"
...
void read_mnist_char1(const char *file_path, int num_data, int len_info, int arr_n, unsigned char data_char[][SIZE], int info_arr[])
{
    int i,  fd;
    unsigned char *ptr;
...
void read_mnist_char2(const char *file_path, int num_data, int len_info, int arr_n, unsigned char data_char[][SIZE], int info_arr[])
{
    int i,  fd;
    unsigned char *ptr;
...
void read_mnist_char3(const char *file_path, int num_data, int len_info, int arr_n, unsigned char data_char[][1], int info_arr[])
{
    int i,  fd;
    unsigned char *ptr;
...
void read_mnist_char4(const char *file_path, int num_data, int len_info, int arr_n, unsigned char data_char[][1], int info_arr[])
{
    int i,  fd;
    unsigned char *ptr;
...
void load_mnist()
{
    read_mnist_char1(TRAIN_IMAGE, NUM_TRAIN, LEN_INFO_IMAGE, SIZE, train_image_char, info_image);
    image_char2double(NUM_TRAIN, train_image_char, train_image);

    read_mnist_char2(TEST_IMAGE, NUM_TEST, LEN_INFO_IMAGE, SIZE, test_image_char, info_image);
    image_char2double(NUM_TEST, test_image_char, test_image);
    
    read_mnist_char3(TRAIN_LABEL, NUM_TRAIN, LEN_INFO_LABEL, 1, train_label_char, info_label);
    label_char2int(NUM_TRAIN, train_label_char, train_label);
    
    read_mnist_char4(TEST_LABEL, NUM_TEST, LEN_INFO_LABEL, 1, test_label_char, info_label);
